...
Source: notebook/04_timeline_planner_agent.ipynb + notebook/05_tracks_ai_graph.ipynb
...
from src.schemas.timeline_schema import TimelineOutput
...
def run_timeline_generation(roadmap: dict, preferences: dict) -> TimelineOutput:
    ...
    Args:
        ...
        preferences: dict with learner preferences.
                     Expected keys: daily_hours, weekly_availability,
                     learning_style, goal.
